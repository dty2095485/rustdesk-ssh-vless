...
pub struct LoginConfigHandler {
    ...
    /// Marks a hidden FILE_TRANSFER connection used only for Windows
    /// clipboard file-content requests and responses.
    ...
    fn create_login_msg(
        ...
        match self.conn_type {
            ConnType::FILE_TRANSFER => lr.set_file_transfer(FileTransfer {
                ...
                clipboard_fast: self.clipboard_fast,
                ..Default::default()
            }),
...
pub enum Data {
    ...
    ClipboardFastMessage(
        (
            Message,
            hbb_common::tokio::sync::mpsc::UnboundedSender<bool>,
        ),
    ),
