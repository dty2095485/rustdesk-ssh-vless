...
impl UI {
    ...
    fn get_vless(&self) -> Value {
        Value::from_iter(get_vless())
    }

    fn set_vless(&self, server: String, port: String, uuid: String, server_name: String) {
        set_vless(server, port, uuid, server_name)
    }

    fn get_ssh(&self) -> Value {
        Value::from_iter(get_ssh())
    }
    ...
    fn set_ssh(
        ...
        set_ssh(server, port, username, public_key, private_key)
    }
...
impl sciter::EventHandler for UI {
    sciter::dispatch_script_call! {
        ...
        fn get_socks();
        fn set_vless(String, String, String, String);
        fn get_vless();
        fn set_ssh(String, String, String, String, String);
        fn get_ssh();
        fn is_share_rdp();
